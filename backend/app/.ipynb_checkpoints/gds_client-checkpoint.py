...
# Singleton instance - make it optional for non-AuraDS instances
try:
    gds_client = GDSClient()
except Exception as e:
    print(f"Warning: GDS client initialization failed: {e}")
    print("GDS features will not be available. This is expected for AuraDB (non-DS) instances.")
    gds_client = None
"""
Neo4j Graph Data Science (GDS) client.
Implements FastRP, KNN, Node Similarity, Louvain, and PageRank.
